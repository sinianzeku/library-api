...
def insertnewbook(**kwargs):
    ...
    sql = "insert into book_info ({},{},{},{},{},{},{},{},{},{},{},{}) values ('{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}')".format(
        list_key[0],list_key[1],list_key[2],list_key[3],list_key[4],list_key[5],list_key[6],list_key[7],list_key[8],list_key[9],list_key[10],list_key[11],
        list_value[0],list_value[1],list_value[2],list_value[3],list_value[4],list_value[5],list_value[6],list_value[7],list_value[8],list_value[9],list_value[10],list_value[11])
